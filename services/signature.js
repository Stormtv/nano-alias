...
function keyFromAccount (account) {
  if ((account.startsWith('xrb_1') || account.startsWith('xrb_3') || account.startsWith('nano_1') || account.startsWith('nano_3')) && (account.length == 64 || account.length == 65)) {
    var account_crop = null
    if (account.length == 64) {
      account_crop = account.substring(4,64)
    } else if (accout.length == 65) {
