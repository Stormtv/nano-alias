...
let message = "fuck this shit, it sucks";
let uint8msg = hex_uint8(message);
let signed = nacl.sign.detached(uint8msg, hex_uint8(sk));
let verified = nacl.sign.detached.verify(uint8msg, signed, hex_uint8(kfa));
